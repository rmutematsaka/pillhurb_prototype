...
<div class="btn-toolbar mb-2 mb-md-0">
  <div class="btn-group me-2">
		...
		<a type="button" class="btn btn-outline-dark btn-sm" href="<?php echo url_for('app/app_mta/');?>" data-abc="true">
...
<div class="row mb-4">
	...
	<div class="col-sm-6">
		<div class="text-end"><strong>Receipt:</strong> <?php echo 'MTR_'.str_pad($value['dom_remittance_id'],10,0,STR_PAD_LEFT); ?></div>
		<div class="text-end"><strong>Receipted:</strong> <?php echo $value['dom_remittance_closed_timestamp']; ?></div>
		<div class="text-end"><strong>Reprinted:</strong> <?php echo $timestamp; ?></div>
		<div class="text-end"><strong>Teller:</strong> <?php echo $value['dom_remittance_closed_agent']; ?></div>
		<!--<div>
		<strong>-</strong>
		</div>-->
	</div>
