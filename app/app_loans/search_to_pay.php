  ...
  <div class="container my-5">
		<form id="form-sellforex" action="" method="POST">
			...
			<div class="form-floating col mb-3 mt-3 ml-auto gx-1">
				<input type="text" class="form-control" id="floatingName" name="search_reference" placeholder="Name" autofocus>
				<label for="floatingName">Search loan reference number</label>
			</div>
				<input type="hidden" name="btnSearchReference">
			</div>
			<div class="row">
				<?php
